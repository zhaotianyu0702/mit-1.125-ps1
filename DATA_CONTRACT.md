...
The reproducible sensitivity study is `research/skill-threshold-study.md` with full results in JSON; regenerate using `node scripts/analyze-skill-thresholds.mjs`. Sixty percent is a product default, not a calibrated employment criterion.
